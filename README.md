...
For this phase I loaded `SSL-decryption.pcap`. The session had successfully negotiated TLS 1.2, so Wireshark was only showing encrypted records. Following the TLS stream gave me nothing, just binary garbage.
